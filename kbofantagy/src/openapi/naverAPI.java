...
public class naverAPI {
	...
	public naverAPI(String teamname){
		this.teamname = teamname;
	}
	
	public String getNews() throws ClientProtocolException, IOException{
		
		String clientId = "kM3z_TTF70jgaTvGxtrV";
		String clientSecret = "v4LXgoU_CL";
		String url = "https://openapi.naver.com/v1/search/news.xml?query="+teamname+"&display=100&start=1&sort=date";
	    //요청처리
	    HttpClient client = HttpClientBuilder.create().build();//요청주체
	    HttpGet req = new HttpGet(url);//reqest 객체
