...
<script type="text/javascript">
	$(document).ready(function () {
		$("#ajaxbtn").on("click", function(){
			$.get("/kbofantasy/livetext.do",{"month":'<%= month %>'},{"eventId":'<%= eventId %>'},{"Inn":$('<%="+$("#page"+i).text()) %>')},live);
		});
	});
	function live(txt){	//서버와 통신이 성공하면 처리결과를 success에 지정한 함수를 호출하며 넘겨준다.
		
		$("#mydiv").html("get"+txt);	//document.getElementByid().innerhtml = xhr.responseText와 동일
	}
	$(document).ready(function(){
				kbo = '<%=kbo%>';
				Inn = '<%=Inn%>';
        ...
        <div class="row">
          <div class="col-md-4 text-center">
            <div class="col-md-12">
              <ul class="pagination">
                <li>
                  <a id="page1" class="page">1</a>
                </li>
                <li>
                  <a id="page2" class="page">2</a>
                </li>
                <li>
                  <a id="page3" class="page">3</a>
                </li>
                <li>
                  <a id="page4" class="page">4</a>
                </li>
                <li>
                  <a id="page5" class="page">5</a>
                </li>
                <li>
                  <a id="page6" class="page">6</a>
                </li>
                <li>
                  <a id="page7" class="page">7</a>
                </li>
                <li>
                  <a id="page8" class="page">8</a>
                </li>
                <li>
                  <a id="page9" class="page">9</a>
                </li>
                <li>
                  <a id="pageext" class="page">연장</a>
                </li>
              </ul>
            </div>
